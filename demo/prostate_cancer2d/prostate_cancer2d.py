...
in 2016 [Lorenzo2016] _ using FEniCS and mocafe.
...
growth pattern of prostate cancer at tissue scale [Lorenzo2016] _.
...
However, the very same operation can be performed quicker using a util method of mocafe, 
``{get_mixed_function_space.__name__}``, which can be used as follows:
"""
...
.. [Lorenzo2016] Lorenzo, G., Scott, M. A., Tew, K., Hughes, T. J. R., Zhang, Y. J., Liu, L., Vilanova, G., & Gomez, H.
    (2016). Tissue-scale, personalized modeling and simulation of prostate cancer growth.
