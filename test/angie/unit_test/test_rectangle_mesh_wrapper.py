...
def is_point_in_mesh(mesh):
    ...
    # gather
    is_point_in_local_mesh_array = fenics.MPI.comm_world.gather(is_point_in_local_mesh)
    if fenics.MPI.comm_world.Get_rank():
        is_point_in_global_mesh = any(is_point_in_local_mesh_array)
    else:
        is_point_in_global_mesh = None
    is_point_in_global_mesh = fenics.MPI.comm_world.bcast(is_point_in_global_mesh, 0)
