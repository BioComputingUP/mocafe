...
from expressions import AngiogenesisInitialCondition
...
from __init__ import project_folder
...
def run_simulation(parameters_file: pathlib.Path, expression_function_parameters: dict,
    ...
    # define data folder
    data_folder = mansimd.setup_data_folder(sim_name, base_location=project_folder)
...
def main():
    # define expression function parameters
    expression_function_parameters = {"type": "None"}
    # define parameters file
    parameters_file = project_folder / pathlib.Path("input_files/parameters.ods")
    # run simulation
    run_simulation(parameters_file,
                   expression_function_parameters)
